...
<html lang="en">
<head>
    <title>Code coverage report for src/preprocessors/files.coffee</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/preprocessors/</a> files.coffee
    </h1>
    <div class='clearfix'>
...
37
38
39</td><td class="line-coverage quiet"><span class="cline-any cline-yes">5×</span>
...
<span class="cline-any cline-yes">5×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">_ = require "underscore"
path = require "path"
glob = require "glob"
&nbsp;
findFiles = (jscpd) -&gt;
...
prepareOptions = (jscpd) -&gt;
  if jscpd.options.files is null
    ...
    unless Array.isArray(jscpd.options.files)
      ...
      jscpd.options.patterns = jscpd.options.files
  <span class="missing-if-branch" title="else path not taken" >E</span>if jscpd.options.exclude isnt null
